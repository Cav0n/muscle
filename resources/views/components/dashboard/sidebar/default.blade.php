<div id="sidebar" class="fixed md:sticky top-0 -left-full opacity-0 md:opacity-100 md:left-0 w-full md:w-60 xl:w-80 z-50 h-screen bg-neutral-100 dark:bg-neutral-900 transition-all duration-500
