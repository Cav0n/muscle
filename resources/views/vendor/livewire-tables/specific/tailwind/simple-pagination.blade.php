        ...
        <nav role="navigation" aria-label="Pagination Navigation" class="flex justify-between">
            <span>
                ...
                @if ($paginator->onFirstPage())
                    <span class="relative inline-flex items-center px-4 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default leading-5 rounded-md select-none dark:bg-neutral-700 dark:text-white dark:border-gray-500">
            ...
            <span>
                ...
                @if ($paginator->hasMorePages())
                    ...
                    @endif
                @else
                    <span class="relative inline-flex items-center px-4 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default leading-5 rounded-md select-none dark:bg-neutral-700 dark:text-white dark:border-gray-600">
                        {!! __('pagination.next') !!}
                    </span>
                @endif
            </span>
