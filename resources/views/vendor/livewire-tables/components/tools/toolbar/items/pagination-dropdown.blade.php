    ...
    <select wire:model.live="perPage" id="{{ $tableName }}-perPage"
        {{
            ...
            ->class([
                ...
                'border-gray-300 focus:border-indigo-300 focus:ring-indigo-200 dark:bg-neutral-700 dark:text-white dark:border-gray-600' => $component->isTailwind() && $component->getPerPageFieldAttributes()['default-colors'],
            ])
